...
function Button() {
  ...
  return (
    <div className=" relative">
      <button
      ref={buttonRef}
        className={`pt-1.5 pb-2 px-5 bg-orange-500 rounded-xl text-neutral-100 font-medium flex items-center ring-offset-1 ${
          visible && "ring-2 ring-orange-200"
        } hover:ring-2 hover:ring-orange-200 hover:text-white transition-all ease-out duration-200`}
      ...
      <AnimatePresence>
        {visible && (
          ...
          ref={dropDownRef}
            ...
            className=" absolute top-11 -right-2 p-2 bg-white rounded-lg drop-shadow-sm border border-neutral-200"
          >
            <ul>
